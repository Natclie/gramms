...
import { $ as MissingSharp, tt as NoImageMetadata, v as detector, xt as AstroError, yt as UnsupportedImageFormat } from "./path_BPd2aQf8.mjs";
import { i as resolveDefaultOutputFormat, r as parseQuality, t as baseService } from "./service_J40CuKY9.mjs";
//#region node_modules/.pnpm/astro@7.0.2_@emnapi+core@1._fac3bc12772747f23ca95f46b32a09ad/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./lib_GOuKOsJB.mjs").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).default;
	} catch {
